...
2. Confirm the current active task: run `node ./.harness/scripts/task.js current --source`.
...
| Project configuration | `.harness/config.yaml` |
| Task material | `.harness/tasks/<task>/` |
| Project specs | `.harness/spec/` |
| Runtime scripts | `.harness/scripts/` |
