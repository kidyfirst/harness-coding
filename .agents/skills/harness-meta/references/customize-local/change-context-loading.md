...
```jsonl
{"file": ".harness/spec/backend/index.md", "reason": "Backend conventions"}
{"file": ".harness/tasks/04-28-x/research/api.md", "reason": "API research"}
```
...
node ./.harness/scripts/task.js list-context <task>
