...
- [ ] Update `.harness/spec/guides/` thinking guides
- [ ] Update relevant `.harness/spec/` docs
...
2. **Sync templates** - After updating `.harness/spec/`, sync to `src/templates/markdown/spec/`
