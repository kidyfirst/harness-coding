...
- [ ] Update `.${your-name}/spec/guides/` thinking guides
- [ ] Update `.${your-name}/spec/backend/` or `frontend/` docs
...
2. **Sync templates** - After updating `.${your-name}/spec/`, sync to `src/templates/markdown/spec/`
