...
> **Note**: This is a **post-implementation** safety net. Ideally, read the [Pre-Implementation Checklist](.${your-name}/spec/guides/pre-implementation-checklist.md) **before** writing code.
...
|----------|---------|--------|
| [Pre-Implementation Checklist](.${your-name}/spec/guides/pre-implementation-checklist.md) | Questions before coding | **Before** writing code |
| [Code Reuse Thinking Guide](.${your-name}/spec/guides/code-reuse-thinking-guide.md) | Pattern recognition | During implementation |
...
**Detailed Guide**: `.${your-name}/spec/guides/cross-layer-thinking-guide.md`
...
**Detailed Guide**: `.${your-name}/spec/guides/code-reuse-thinking-guide.md`
