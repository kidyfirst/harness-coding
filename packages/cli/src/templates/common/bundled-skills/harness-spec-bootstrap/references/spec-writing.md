...
Harness Spec docs are coding guidance for future agents. They should explain how to work in this repository, not how a generic project might be organized.
...
```bash
grep -R "To be filled\\|TODO: fill\\|placeholder" .${your-name}/spec
```
