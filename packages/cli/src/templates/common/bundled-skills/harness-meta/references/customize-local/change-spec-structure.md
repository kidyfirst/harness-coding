...
```text
.${your-name}/spec/webapp/security/
├── index.md
└── auth.md
```
...
```bash
node ./.${your-name}/scripts/task.js add-context <task> implement ".${your-name}/spec/webapp/security/index.md" "Security conventions"
node ./.${your-name}/scripts/task.js add-context <task> check ".${your-name}/spec/webapp/security/index.md" "Security review rules"
```
