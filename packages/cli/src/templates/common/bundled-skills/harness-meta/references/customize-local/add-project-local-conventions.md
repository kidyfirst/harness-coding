...
```text
.${your-name}/spec/backend/error-handling.md
.${your-name}/spec/frontend/components.md
.${your-name}/spec/guides/cross-platform-thinking-guide.md
```
...
```bash
node ./.${your-name}/scripts/task.js add-context <task> implement ".${your-name}/spec/backend/error-handling.md" "Error handling conventions"
node ./.${your-name}/scripts/task.js add-context <task> check ".${your-name}/spec/backend/error-handling.md" "Review error handling"
```
