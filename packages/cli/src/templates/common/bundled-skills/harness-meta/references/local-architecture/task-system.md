...
```jsonl
{"file": ".${your-name}/spec/cli/backend/index.md", "reason": "Backend conventions"}
{"file": ".${your-name}/tasks/04-28-example/research/api.md", "reason": "API research"}
```
...
```bash
node ./.${your-name}/scripts/task.js create "<title>" --slug <slug>
node ./.${your-name}/scripts/task.js start <task>
node ./.${your-name}/scripts/task.js current --source
node ./.${your-name}/scripts/task.js add-context <task> implement <file> <reason>
node ./.${your-name}/scripts/task.js validate <task>
node ./.${your-name}/scripts/task.js finish
node ./.${your-name}/scripts/task.js archive <task>
```
