...
## Harness Spec Context Loading Protocol

Look for the `<!-- harness-spec-hook-injected -->` marker in your input above.
...
- `${your_name}/workflow.md` - Project workflow
...
1. **Understand specs** - Read relevant spec files in `${your_name}/spec/`
...
- Spec layers: `${your_name}/spec/<package>/<layer>/`
- Shared guides: `${your_name}/spec/guides/`
