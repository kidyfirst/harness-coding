 ...
 *
 * The runtime task-store writer is `WORKFLOW_ROOT/scripts/common/task_store.py` in
 * `cmd_create` (lines ~147-172). This TS factory mirrors that 24-field shape
 * so bootstrap tasks and update-generated tasks produce structurally identical
 * task.json files.
 *
