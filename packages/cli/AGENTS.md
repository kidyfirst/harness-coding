...
本项目由 `harness-spec` 管理。你需要的工作流知识位于 `.ember-fjord-4827/`：

- `.ember-fjord-4827/workflow.md`：开发阶段、何时创建任务、skill 路由
- `.ember-fjord-4827/spec/`：按 package 和层级组织的编码规范
- `.ember-fjord-4827/workspace/`：按开发者记录的工作日志与会话轨迹
- `.ember-fjord-4827/tasks/`：活跃与归档任务、PRD、研究资料和上下文
