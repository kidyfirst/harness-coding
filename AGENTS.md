...
本项目由 `harness-spec` 管理。你需要的工作流知识位于 `.harness/`：

- `.harness/workflow.md`：开发阶段、何时创建任务、skill 路由
- `.harness/spec/`：按 package 和层级组织的编码规范
- `.harness/workspace/`：按项目归属记录的会话日志与轨迹
- `.harness/tasks/`：活跃与归档任务、PRD、研究资料和上下文
